  ...
  return (
    <div>
      <div className="page-header">
        ...
        {(user?.role === 'admin' || user?.permissions?.includes('CREATE_DEPARTMENT')) && (
          ...
          <table>
            ...
            <tbody>
              {departments.map((dept) => (
                ...
                {(user?.role === 'admin' || user?.permissions?.includes('EDIT_DEPARTMENT')) && (
                      <button onClick={() => handleOpenModal(dept)} className="btn btn-sm btn-outline">Sửa</button>
                    )}
                {(user?.role === 'admin' || user?.permissions?.includes('DELETE_DEPARTMENT')) && (
